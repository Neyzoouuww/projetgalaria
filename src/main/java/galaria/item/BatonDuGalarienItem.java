...
public class BatonDuGalarienItem extends GalariaModElements.ModElement {
	@ObjectHolder("galaria:baton_du_galarien")
	public static final Item block = null;
	public BatonDuGalarienItem(GalariaModElements instance) {
		super(instance, 35);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.getPosZ();
				{
					...
					BatonDuGalarienRightClickedInAirProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("baton_du_galarien"));
	}
