...
public class CharbonGalariaItem extends GalariaModElements.ModElement {
	@ObjectHolder("galaria:charbon_galaria")
	public static final Item block = null;
	public CharbonGalariaItem(GalariaModElements instance) {
		super(instance, 23);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("charbon_galaria");
		}
