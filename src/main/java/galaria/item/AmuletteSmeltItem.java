...
public class AmuletteSmeltItem extends GalariaModElements.ModElement {
	@ObjectHolder("galaria:amulette_smelt")
	public static final Item block = null;
	public AmuletteSmeltItem(GalariaModElements instance) {
		super(instance, 56);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("amulette_smelt");
		}
