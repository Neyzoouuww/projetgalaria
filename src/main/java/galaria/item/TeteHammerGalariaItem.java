...
public class TeteHammerGalariaItem extends GalariaModElements.ModElement {
	@ObjectHolder("galaria:tete_hammer_galaria")
	public static final Item block = null;
	public TeteHammerGalariaItem(GalariaModElements instance) {
		super(instance, 42);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tete_hammer_galaria");
		}
