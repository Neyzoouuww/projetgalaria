...
import galaria.item.GalariaMegaCompresserItem;
import galaria.item.GalariaCompresserItem;
...
public class TableCraftGalariaUpdateTickProcedure extends GalariaModElements.ModElement {
	public TableCraftGalariaUpdateTickProcedure(GalariaModElements instance) {
		super(instance, 42);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				GalariaMod.LOGGER.warn("Failed to load dependency x for procedure TableCraftGalariaUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				GalariaMod.LOGGER.warn("Failed to load dependency y for procedure TableCraftGalariaUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				GalariaMod.LOGGER.warn("Failed to load dependency z for procedure TableCraftGalariaUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				GalariaMod.LOGGER.warn("Failed to load dependency world for procedure TableCraftGalariaUpdateTick!");
			return;
		}
		...
		if ((((new Object() {
									...
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										...
										.getItem()) && (((new Object() {
											public ItemStack getItemStack(BlockPos pos, int sltid) {
												...
												.getItem() == new ItemStack(GalariaCompresserItem.block, (int) (1)).getItem()) && (((new Object() {
													public ItemStack getItemStack(BlockPos pos, int sltid) {
														AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
														TileEntity _ent = world.getTileEntity(pos);
														if (_ent != null) {
														...
														.getItem() == new ItemStack(GalariaCompresserItem.block, (int) (1)).getItem())
														&& (((new Object() {
															public ItemStack getItemStack(BlockPos pos, int sltid) {
																AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
																TileEntity _ent = world.getTileEntity(pos);
																	...
																	public ItemStack getItemStack(BlockPos pos, int sltid) {
																		...
																		&& ((new Object() {
																			public ItemStack getItemStack(BlockPos pos, int sltid) {
																				...
																				.getItem() == new ItemStack(GalariaCompresserItem.block, (int) (1))
																						.getItem())))))))))
				&& ((((new Object() {
					public int getAmount(IWorld world, BlockPos pos, int sltid) {
						AtomicInteger _retval = new AtomicInteger(0);
					...
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						.getItem() == new ItemStack(GalariaMegaCompresserItem.block, (int) (1)).getItem())) || ((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								if (_ent != null) {
			...
			}
			{
				...
				if (_ent != null) {
					...
					final ItemStack _setstack = new ItemStack(GalariaMegaCompresserItem.block, (int) (1));
