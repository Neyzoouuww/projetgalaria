...
public class VraiHammerSmeltGalariaBlockDestroyedWithToolProcedure extends GalariaModElements.ModElement {
	public VraiHammerSmeltGalariaBlockDestroyedWithToolProcedure(GalariaModElements instance) {
		super(instance, 80);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				GalariaMod.LOGGER.warn("Failed to load dependency entity for procedure VraiHammerSmeltGalariaBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				GalariaMod.LOGGER.warn("Failed to load dependency x for procedure VraiHammerSmeltGalariaBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				GalariaMod.LOGGER.warn("Failed to load dependency y for procedure VraiHammerSmeltGalariaBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				GalariaMod.LOGGER.warn("Failed to load dependency z for procedure VraiHammerSmeltGalariaBlockDestroyedWithTool!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				GalariaMod.LOGGER.warn("Failed to load dependency world for procedure VraiHammerSmeltGalariaBlockDestroyedWithTool!");
			return;
		}
