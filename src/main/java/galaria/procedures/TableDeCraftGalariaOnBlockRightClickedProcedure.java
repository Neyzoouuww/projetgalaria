...
import galaria.item.VraiHammerSmeltGalariaItem;
import galaria.item.TeteHammerGalariaItem;
import galaria.item.HammerGalariaItem;
import galaria.item.BationGalariaItem;
import galaria.item.AmuletteSmeltItem;
...
public class TableDeCraftGalariaOnBlockRightClickedProcedure extends GalariaModElements.ModElement {
	public TableDeCraftGalariaOnBlockRightClickedProcedure(GalariaModElements instance) {
		super(instance, 74);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				GalariaMod.LOGGER.warn("Failed to load dependency x for procedure TableDeCraftGalariaOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				GalariaMod.LOGGER.warn("Failed to load dependency y for procedure TableDeCraftGalariaOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				GalariaMod.LOGGER.warn("Failed to load dependency z for procedure TableDeCraftGalariaOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				GalariaMod.LOGGER.warn("Failed to load dependency world for procedure TableDeCraftGalariaOnBlockRightClicked!");
			return;
		}
		...
		if ((((new Object() {
			...
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(TeteHammerGalariaItem.block, (int) (1))
						.getItem()) && (((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
									...
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										...
										.getItem()) && (((new Object() {
											public ItemStack getItemStack(BlockPos pos, int sltid) {
												...
												.getItem() == new ItemStack(BationGalariaItem.block, (int) (1)).getItem()) && (((new Object() {
													public ItemStack getItemStack(BlockPos pos, int sltid) {
														AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
														TileEntity _ent = world.getTileEntity(pos);
														if (_ent != null) {
															...
															public ItemStack getItemStack(BlockPos pos, int sltid) {
																...
																.getItem() == new ItemStack(Blocks.AIR, (int) (1)).getItem()) && (((new Object() {
																	public ItemStack getItemStack(BlockPos pos, int sltid) {
																		...
																		.getItem() == new ItemStack(BationGalariaItem.block, (int) (1)).getItem())
																		&& ((new Object() {
																			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (9))).getItem() == new ItemStack(HammerGalariaItem.block, (int) (1))
						.getItem())) || ((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
			...
			public ItemStack getItemStack(BlockPos pos, int sltid) {
							...
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								...
								.getItem()) && (((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										...
										.getItem() == new ItemStack(AmuletteSmeltItem.block, (int) (1)).getItem()) && (((new Object() {
											public ItemStack getItemStack(BlockPos pos, int sltid) {
												AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
												TileEntity _ent = world.getTileEntity(pos);
												if (_ent != null) {
												...
												.getItem() == new ItemStack(HammerGalariaItem.block, (int) (1)).getItem()) && (((new Object() {
													public ItemStack getItemStack(BlockPos pos, int sltid) {
														AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
														TileEntity _ent = world.getTileEntity(pos);
														if (_ent != null) {
				...
				&& ((((new Object() {
					...
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						.getItem() == new ItemStack(VraiHammerSmeltGalariaItem.block, (int) (1)).getItem())) || ((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								if (_ent != null) {
