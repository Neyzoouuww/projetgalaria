...
public class TableDeCraftGalariaGUIGui extends GalariaModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public TableDeCraftGalariaGUIGui(GalariaModElements instance) {
		super(instance, 77);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("table_de_craft_galaria_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, TableDeCraftGalariaGUIGuiWindow::new));
	}
